...
import com.jwetherell.QRComm575.data.Contents;
import com.jwetherell.QRComm575.qrcode.QRCodeEncoder;
...
public final class EncoderActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            qrCodeEncoder = new QRCodeEncoder(message, null, Contents.Type.TEXT, BarcodeFormat.QR_CODE.toString(), smallerDimension);
