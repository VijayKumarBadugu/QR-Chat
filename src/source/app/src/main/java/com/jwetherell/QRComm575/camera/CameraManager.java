...
package com.jwetherell.QRComm575.camera;
...
import com.jwetherell.QRComm575.PlanarYUVLuminanceSource;
import com.jwetherell.QRComm575.data.Preferences;
...
public final class CameraManager {
    ...
    public void closeDriver() {
        ...
        if (camera != null) {
            camera.release();
            System.out.println("Came in close Driver");
            camera = null;
